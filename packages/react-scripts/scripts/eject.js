...
const inquirer = require('akomkov-react-dev-utils/inquirer');
const spawnSync = require('akomkov-react-dev-utils/crossSpawn').sync;
const os = require('os');
...
inquirer
  ...
  .then(answer => {
    ...
    const folders = ['config', 'config/karma.conf', 'scripts'];
